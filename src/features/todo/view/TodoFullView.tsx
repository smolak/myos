    ...
    <div className="flex flex-col h-full bg-zinc-950 text-zinc-100">
      ...
      <div className="flex-1 overflow-auto p-6">
        <form onSubmit={handleAdd} className="flex gap-2 mb-6">
          ...
          />
          <button type="submit" className="bg-zinc-700 hover:bg-zinc-600 px-4 py-2 rounded text-sm transition-colors">
            Add
          </button>
        </form>
        ...
        {activeTodos.length > 0 && (
          <section className="mb-6">
            <h3 className="text-xs font-medium text-zinc-500 uppercase tracking-wide mb-3">Active</h3>
        ...
        {completedTodos.length > 0 && (
          <section>
            <h3 className="text-xs font-medium text-zinc-500 uppercase tracking-wide mb-3">Completed</h3>
            <ul className="space-y-2">
        ...
        {todos.length === 0 && <p className="text-center text-zinc-500 text-sm py-12">No todos yet. Add one above!</p>}
      </div>
    </div>
  );
}
